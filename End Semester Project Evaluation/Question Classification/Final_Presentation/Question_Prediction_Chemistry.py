...
data = pd.read_csv('chemistry.csv')
data.columns
# print(data)
...
accuracy_SVM_CV, SVM_Classifier = train_model( svm.SVC(C = 5, gamma=0.5), xtrain_count, train_y, xvalid_count)
print("LR, Count Vectors: ", accuracy_SVM_CV)

# Support Vector Machine on Word Level Tf-Idf Vectors
accuracy_SVM_TF_IDF, SVM_Classifier = train_model( svm.SVC(C = 5, gamma=0.5), xtrain_tfidf, train_y, xvalid_tfidf)
print("LR, WordLevel Tf-Idf: ", accuracy_SVM_TF_IDF)

# Support Vector Machine on Ngram Level Tf-Idf Vectors
accuracy = train_model( svm.SVC(C = 5, gamma=0.5), xtrain_tfidf_ngram, train_y, xvalid_tfidf_ngram)
print("LR, N-Gram Vectors: ", accuracy)
...
class Login(QWidget, login):
    ...
    def Handle_Login(self):
        ...
        # for row in data:
        if username == "Ajay Raikar" and password == "12345":
            print('user match')
...
class Predict(QMainWindow, predict):
    def __init__(self):
        ...
        self.pushButton_2.clicked.connect(self.call_back)
        ...
        # # # test_chem.head()
        # #
        # print("printing test_chem_column", test_chem.columns)
        ...
        # questions = pd.DataFrame(questions)
        # # # questions.head()
        # test_chem['Question'] = questions
        # # # data.head()
        # test_x = test_chem['Question']
